...
# Bot information
API_ID = environ.get('API_ID', '25863720')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5738825104')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002805072900').split()]
if len(INDEX_CHANNELS) == 0:
    logger.info('INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002518144043')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002891021561')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://abhinavnarendra406Tcd7enIpdr4NOaxcluster0.y7xyrkv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(DATA_DATABASE_URL) == 0:
    logger.error('DATA_DATABASE_URL is missing, exiting now')
    exit()
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://abhinavnarendra406Tcd7enIpdr4NOaxcluster0.y7xyrkv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(FILES_DATABASE_URL) == 0:
    logger.error('FILES_DATABASE_URL is missing, exiting now')
    exit()
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', "mongodb+srv://abhinavnarendra24:HLLYOwd339JIgxWe@cluster0.sbueait.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/+pr1wKQaWcTcwMTVl')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/+pr1wKQaWcTcwMTVl')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+9qDpuVfd1dpiMGM9')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/akfrkkdkwkckggk")
